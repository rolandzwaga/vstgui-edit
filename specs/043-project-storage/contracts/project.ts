...
/**
 * Project service for IndexedDB operations.
 */
export interface ProjectService {
  ...
  /** Delete a project and all its bitmaps */
  delete(id: string): Promise<void>;
}

/**
 * Bitmap service for IndexedDB operations.
 */
export interface BitmapService {
  /** Add a bitmap to a project */
  add(bitmap: Bitmap): Promise<void>;

  /** Get a bitmap by ID */
  get(id: string): Promise<Bitmap | undefined>;

  /** Get all bitmaps for a project */
  getByProject(projectId: string): Promise<Bitmap[]>;

  /** Delete a bitmap */
  delete(id: string): Promise<void>;

  /** Delete all bitmaps for a project */
